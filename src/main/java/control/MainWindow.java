...
public class MainWindow implements Initializable {
        ...
        public void handle(ActionEvent event) {
            ...
            if (!empezar) {
                ...
                if (Math.random() < cuantos)  {
                    ...
                    if (numRandom == 1) {
                        Globo globo = new Globo(new Image("images/morado.png", 63, 114, false, false), "morado");
                        globos.add(globo);
                    } else if (numRandom == 2){
                        Globo globo = new Globo(new Image("images/amarillo.png", 63, 114, false, false), "amarillo");
                        globos.add(globo);
                    } else if (numRandom == 3){
                        Globo globo = new Globo(new Image("images/verde.png", 63, 114, false, false), "verde");
                        globos.add(globo);
                    } else {
                        Globo globo = new Globo(new Image("images/rojo.png", 63, 114, false, false), "rojo");
                        globos.add(globo);
                    }
                }
                ...
                for (int i = 0; i < globos.size(); i++) {
                    ...
                    // todoo el rato causando la perdida de todas las vidas en milesimas de segundo
    ...
    private void contadores() {
        ...
        } else if (contadorGlobosReventados == 110) {
            cuantos = 0.023;
            nivel = 12;
    ...
    private void prints() {
        ...
        //Color del texto de los globos a reventar
        if (colorAReventar.equals("morado")) {
